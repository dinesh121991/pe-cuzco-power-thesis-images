...
#        png(file="Power_consumption_wattmeter.png",height=1000,width=1000)
	postscript("cr_crl_28_ju_ex-2-width-20.eps",width=20,height=10,onefile = TRUE, horizontal = FALSE,paper="special")
...
ConsAllEnergy("cr_pl_jl_ex-1.compl.data","crl_pl_jl-ex-2.compl.dat")

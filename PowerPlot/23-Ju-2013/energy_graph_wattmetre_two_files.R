...
#        png(file="Power_consumption_wattmeter.png",height=1000,width=1000)
	postscript("cr_crl_power.eps",width=10,height=10,onefile = TRUE, horizontal = FALSE,paper="special")
        plot(Tps_f,Watt_f,type="l",xlab="Time (sec)",col="red",ylim=c(0,max(Watt_f,Watt_p)),ylab="Instant Power Consumption [Watt]",main="Power consumption comparison of two policies cons_res and cons_res_power")
...
#	axis(4,col="red",col.axis="red")
	mtext("Cons_res_power Power Consumption [Watt]",side=4,col="red")
...
ConsAllEnergy("cr_pl.compl.dat","crl_pl.compl.dat")
